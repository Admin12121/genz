...
const UserActive = () => {
    ...
    useEffect(() => {
        const activateUser = async () => {
          try {
            const response = await axios.get(`http://localhost:8000/user/activate/${uidb64}/${token}/`);
            if(response.data){
  ...
  return (
    <>
        ...
        <div class="card"> 
                    <div class="header"> 
                        <div class="image">
                            {success  ?   <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"><g strokeWidth="0" id="SVGRepo_bgCarrier"></g><g stroke-linejoin="round" stroke-linecap="round" id="SVGRepo_tracerCarrier"></g><g id="SVGRepo_iconCarrier"> <path stroke-linejoin="round" stroke-linecap="round" strokeWidth="1.5" stroke="#000000" d="M20 7L9.00004 18L3.99994 13"></path> </g></svg>: 
