...
const Load = () => {
  return (
    <>
  <div className="Course_wrapper pro-course-wrapper" >
          <div className="Course_card proj-course-card">
              <div className="course_image pro-course-img">
                  <div className="iframe_link"></div>
              </div>
              <div className="text_area">
                  <span className="user-project">
                      <span>
                          <Link  className="img_loader">
                          </Link>
                      </span>
                      <span className="text_loaderw">
                          <h1 ></h1>
                  ...
                  <span className="project-vieww" style={{ gap: "10px" }}>
                      <p> </p>
                      <span className="project-starr">
